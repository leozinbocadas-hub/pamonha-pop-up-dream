      ...
      <div className="flex flex-col gap-6 max-w-sm mx-auto">
        ...
        >
          ...
          <ul className="space-y-2 mb-6 text-sm text-foreground text-left">
            ...
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
              <span><strong>Área de Membros Web:</strong> App otimizado para usar no celular.</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
        ...
        >
          ...
          <ul className="space-y-3 mb-8 text-sm text-primary-foreground text-left">
            <li className="flex items-start gap-2">
              ...
              <span><strong>Tudo do Essencial MAIS:</strong></span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-secondary flex-shrink-0" />
              <span><strong>+200 Receitas Exclusivas:</strong> Gourmet, Inovadoras e Internacionais.</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-secondary flex-shrink-0" />
              <span><strong>16 Bônus Estratégicos:</strong> Calculadoras de Lucro e Marketing Local.</span>
            </li>
            <li className="flex items-start gap-2">
              <Check className="w-5 h-5 text-secondary flex-shrink-0" />
              <span><strong>Acesso Vitalício:</strong> Suporte Platinum e Atualizações Contínuas.</span>
            </li>
          </ul>
          <div className="mb-4">
          ...
          >
            QUERO O MÉTODO COMPLETO <Rocket className="w-5 h-5" />
          </button>
        </div>
      </div>
